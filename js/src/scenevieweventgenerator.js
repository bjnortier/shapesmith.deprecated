define(['src/calculations', 'src/scene', 'src/geometrygraphsingleton'], function(calc, sceneModel, geometryGraph) {
    ...
    var EventGenerator = function() {
        ...
        this.mousemove = function(event) {
            ...
            if (firstMouseOverView) {
                ...
                if (viewsForEvent[0] !== firstMouseOverView) {
                    ...
                    viewsForEvent[0] && viewsForEvent[0].trigger('mouseenterfirst', intersections[0]);
                }
            } else {
                if (viewsForEvent[0]) {
        ...
        this.findClosestNonEditingEdge = function(event) {
            ...
            var closestEdgePosition = undefined;
            var closestEdgeDistance = undefined;
