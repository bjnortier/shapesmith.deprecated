define(['underscore', 'src/casgraph/graph', 'src/casgraph/replicator'], function(_, CASGraph, Replicator) {
    ...
    describe('CAS Graph Replicator', function() {
        ...
        it('can write vertices', function() {
            ...
            var read = function(hash, callback) {
                throw Error('read should not be called');
            }
        ...
        it('can read a graph', function(done) {
            ...
            var write = function(hash, object, callback) {
                throw Error('write should not be called');
            }
            ...
            var readGraph = function(hash, callback) {
                if (hash === '_graphhash') {
                    ...
                    throw Error('unexpected graph hash')
                }
            }
            ...
            var readVertex = function(hash, callback) {
                if (hash === '_a') {
                    ...
                    throw Error('unexpected vertex hash')
                }
            }
