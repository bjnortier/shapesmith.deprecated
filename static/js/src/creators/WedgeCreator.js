...
SS.WedgePreview = SS.PreviewWithOrigin.extend({
    ...
    render: function() {
       ...
       if (u1 && v && u2) {
           ...
           uvLineGeom.vertices.push(new THREE.Vector3(0, 0, 0));
           uvLineGeom.vertices.push(new THREE.Vector3(u1, 0, 0));
           uvLineGeom.vertices.push(new THREE.Vector3(u2, v, 0));
           uvLineGeom.vertices.push(new THREE.Vector3(0, v, 0));
           uvLineGeom.vertices.push(new THREE.Vector3(0, 0, 0));
